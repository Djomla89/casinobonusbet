...
.entry-header h1{display: none;}
					...
					<div class="welcome">
						...
						<h3>CASINO BONUS: No Deposit Bonus & Deposit Bonus</h3>
					...
					<div class="goldOffers">
						...
						<ul class="golden">
						    <li><a href="<?php echo get_post_meta(6, 'image1_link_value',true); ?>" target="_blank"><img src="<?php echo get_post_meta(6, 'image1_value',true); ?>" Alt="Offers" Title="Offers" width="254" height="128"></a></li>
							<li><a href="<?php echo get_post_meta(6, 'image2_link_value',true); ?>" target="_blank"><img src="<?php echo get_post_meta(6, 'image2_value',true); ?>" Alt="Offers" Title="Offers" width="254" height="128"></a></li>
							<li class="lastOffer"><a href="<?php echo get_post_meta(6, 'image3_link_value',true); ?>" target="_blank"><img src="<?php echo get_post_meta(6, 'image3_value',true); ?>" Alt="Offers" Title="Offers" width="254" height="128"></a></li>
					...
					<div class=silverOffers>
						...
						<div class="listHolder">
							...
							<ul>
								<?php query_posts('cat=2&showposts=9');?>

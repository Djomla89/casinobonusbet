...
<ul class="golden">
							...
							<li><a href="<?php echo get_post_meta(10, 'image1_link_value',true); ?>" target="_blank"><img src="<?php echo get_post_meta(10, 'image1_value',true); ?>" Alt="Offers" Title="Offers" width="254" height="128"></a></li>
							<li><a href="<?php echo get_post_meta(10, 'image2_link_value',true); ?>" target="_blank"><img src="<?php echo get_post_meta(10, 'image2_value',true); ?>" Alt="Offers" Title="Offers" width="254" height="128"></a></li>
							<li class="lastOffer"><a href="<?php echo get_post_meta(10, 'image3_link_value',true); ?>" target="_blank"><img src="<?php echo get_post_meta(10, 'image3_value',true); ?>" Alt="Offers" Title="Offers" width="254" height="128"></a></li>
					...
					<div class=silverOffers>
						...
						<div class="listHolder">
							...
							<ul>
								<?php query_posts('cat=4&showposts=9');?>
					...
					<h3 class="red">No Deposit Bonus Offers</h3>
						...
						<div class="offerHolder" style="width:764px;">
							...
							<ul>
							    <?php query_posts('cat=28&showposts=10');?>
			                    <?php while (have_posts($args)) : the_post($args); ?>

	    ...
	    <div class="container">
		    ...
		    <div class="topMenu">
				...
				<?php
					...
					<li><a href="http://www.facebook.com/CasinoBonusBet" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/images/facebook_btn.png" Alt="Facebook" Title="Facebook"></a></li>
					<li><a href="https://twitter.com/casinobonusbett" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/images/twitter_btn.png" Alt="Twitter" Title="Twitter"></a></li>
					<!--<li><a href="#" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/images/linkedin_btn.png" Alt="LinkedIn" Title="LinkedIn"></a></li>-->
...
$(document).ready(function(){
   $("#menuid li:eq(0) a").addClass("home");
	...
	//attr("disabled", "disabled");
				...
				<span><a href="<?php site_url();?>?page_id=30">Support!</a></span>
			...
			<div class="main">
				...
				<div class="leftContent">
					...
					<span><a href="http://www.prowintips.com" target="_blank">Betting Tips</a></span>

...
.entry-header h1{display: none;}
					...
					<div class="welcome">
						...
						<h3>P0KER BONUS: No Deposit Bonus & Deposit Bonus</h3>
					...
					<div class="goldOffers">
						...
						<ul class="golden">
							<li><a href="<?php echo get_post_meta(8, 'image1_link_value',true); ?>" target="_blank"><img src="<?php echo get_post_meta(8, 'image1_value',true); ?>" Alt="Offers" Title="Offers" width="254" height="128"></a></li>
							<li><a href="<?php echo get_post_meta(8, 'image2_link_value',true); ?>" target="_blank"><img src="<?php echo get_post_meta(8, 'image2_value',true); ?>" Alt="Offers" Title="Offers" width="254" height="128"></a></li>
							<li class="lastOffer"><a href="<?php echo get_post_meta(8, 'image3_link_value',true); ?>" target="_blank"><img src="<?php echo get_post_meta(8, 'image3_value',true); ?>" Alt="Offers" Title="Offers" width="254" height="128"></a></li>     
						</ul>
					...
					<h3 class="red">No Deposit Bonus Offers</h3>
						...
						<div class="offerHolder" style="width:764px;">
							...
							<ul>
							    <?php query_posts('cat=27&showposts=10');?>
			                    <?php while (have_posts($args)) : the_post($args); ?>
